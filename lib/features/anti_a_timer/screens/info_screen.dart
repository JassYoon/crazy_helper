              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Rest after slider (only when enabled)
                    AnimatedSize(
                    ...
                    _buildInstruction(
                      '1',
                      '호흡 모드를 선택하세요 (기본 또는 커스텀)',
                    ),
                    _buildInstruction(
                      '2',
                      '시작 버튼을 눌러 도넛 차트의 안내를 따라 호흡하세요',
                    ),
                    _buildInstruction(
                      '3',
                      '설정한 세트만큼 반복하면 자동으로 종료됩니다',
                    ),
                    const SizedBox(height: 32),
                  ],
                ),
